...
Object.keys(ItemMap).forEach((key) => {
  ...
  const renderLoginItem = (props: LoginItemProps) => (
    <LoginContext.Consumer>
      {(context) => <LoginItem customProps={item.props} rules={item.rules} {...props} type={key} {...context} updateActive={context.updateActive} />}
    </LoginContext.Consumer>
  );
  LoginItems[key] = renderLoginItem;
});
