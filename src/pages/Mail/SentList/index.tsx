...
import { SentListItem } from './data';
import './index.less';

const localList: SentListItem[] = [
  {
    id: 51123,
    to: '1289739946@qq.com',
    content: '<p>hello qq用户</p>',
    kinds: 3,
    status: 0,
  ...
  {
    id: 51123,
    to: 'neil.hu@greenpacket.com.cn',
    content: '<h1>新年快乐！登录 http://n.cn/SXn78aA 领取好礼！</h1>',
    kinds: 1,
    status: 2,
...
const MassSent: React.FC<{}> = () => {
  ...
  return (
    <Page className="sms-sent" title="已发送邮件">
